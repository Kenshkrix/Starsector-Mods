...
public class BallisticCalibrationDamage extends BaseHullMod {
	...
	public boolean isApplicableToShip(ShipAPI ship) {
		...
		return !(shipHullMods.contains("khs_ballistic_calibration_flux") || shipHullMods.contains("khs_ballistic_calibration_range") || shipHullMods.contains("khs_ballistic_calibration_rof"));
	}
}
