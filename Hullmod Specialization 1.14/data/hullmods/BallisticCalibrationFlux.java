...
public class BallisticCalibrationFlux extends BaseHullMod {
	
	public static final float BALLISTIC_DAMAGE_MOD = -5f;
	public static final float BALLISTIC_FLUX_MOD = -20f;
	...
	public boolean isApplicableToShip(ShipAPI ship) {
		...
		return !(shipHullMods.contains("khs_ballistic_calibration_damage") || shipHullMods.contains("khs_ballistic_calibration_range") || shipHullMods.contains("khs_ballistic_calibration_rof"));
	}
}
