...
public class EnergyCalibrationROF extends BaseHullMod {
	...
	public static final float ENERGY_ROF_MOD = 20f;
	...
	public boolean isApplicableToShip(ShipAPI ship) {
		...
		return !(shipHullMods.contains("khs_energy_calibration_damage") || shipHullMods.contains("khs_energy_calibration_flux") || shipHullMods.contains("khs_energy_calibration_range"));
	}
}
