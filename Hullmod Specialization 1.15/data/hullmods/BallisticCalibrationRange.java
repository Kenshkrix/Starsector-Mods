...
public class BallisticCalibrationRange extends BaseHullMod {
	
	public static final float BALLISTIC_DAMAGE_MOD = -5f;
	public static final float BALLISTIC_FLUX_MOD = 5f;
	public static final float BALLISTIC_RANGE_MOD = 20f;
	public static final float BALLISTIC_ROF_MOD = -5f;
	...
	public boolean isApplicableToShip(ShipAPI ship) {
		...
		return !(shipHullMods.contains("khs_ballistic_calibration_damage") || shipHullMods.contains("khs_ballistic_calibration_flux") || shipHullMods.contains("khs_ballistic_calibration_rof"));
	}
}
