...
public class EnergyCalibrationRange extends BaseHullMod {
	
	public static final float ENERGY_DAMAGE_MOD = -5f;
	public static final float ENERGY_FLUX_MOD = 5f;
	public static final float ENERGY_RANGE_MOD = 20f;
	...
	public boolean isApplicableToShip(ShipAPI ship) {
		...
		return !(shipHullMods.contains("khs_energy_calibration_damage") || shipHullMods.contains("khs_energy_calibration_flux") || shipHullMods.contains("khs_energy_calibration_rof"));
	}
}
