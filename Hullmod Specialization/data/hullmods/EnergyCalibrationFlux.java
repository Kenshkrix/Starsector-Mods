...
public class EnergyCalibrationFlux extends BaseHullMod {
	
	public static final float ENERGY_DAMAGE_MOD = -5f;
	public static final float ENERGY_FLUX_MOD = -20f;
	...
	public boolean isApplicableToShip(ShipAPI ship) {
		...
		return !(shipHullMods.contains("khs_energy_calibration_damage") || shipHullMods.contains("khs_energy_calibration_range") || shipHullMods.contains("khs_energy_calibration_rof"));
	}
}
