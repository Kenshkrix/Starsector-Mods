...
public class SecondaryShieldEight extends BaseHullMod {

    private static final int SHIELD_SEGMENTS = 8;
    ...
    private static final float SHIELD_ARC = (360f / SHIELD_SEGMENTS) + 10f;
    ...
    private static String DRONE_ID = "shieldbubble_alwayson_variant";
