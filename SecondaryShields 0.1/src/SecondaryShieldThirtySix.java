...
public class SecondaryShieldThirtySix extends BaseHullMod {

    private static final int SHIELD_SEGMENTS = 36;
    private static final float FLUX_CAPACITY = 3600f;
    private static final float FLUX_DISSIPATION = 180f;
    ...
    private static final float SHIELD_ARC = (360f / SHIELD_SEGMENTS) + 2f;
