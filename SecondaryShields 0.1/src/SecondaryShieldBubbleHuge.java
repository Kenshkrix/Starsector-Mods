...
public class SecondaryShieldBubbleHuge extends BaseHullMod {

    private static final int SHIELD_SEGMENTS = 1;
    private static final float FLUX_CAPACITY = 4000f;
    private static final float FLUX_DISSIPATION = 20f;
    private static final float SHIELD_EFFICIENCY = 1.0f;
    private static final float SHIELD_RADIUS = 120f;
